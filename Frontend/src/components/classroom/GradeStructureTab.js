...
const GradeStructureTab = ({ classId, isTeaching }) => {
  ...
  const handleRemoveGrade = async (gradeId) => {
    try {
      await api.delete(`/gradeStructures/remove/${gradeId}`);
      setGradeStructure((prevStructure) =>
        prevStructure.filter((grade) => grade._id !== gradeId)
      );
    } catch (error) {
...
//                     <Button
//                       color="error"
//                       onClick={() => handleRemoveGrade(grade._id)}
//                     >
//                       Remove
//                     </Button>
//                     <Button
//                       color="primary"
//                       onClick={() =>
//                         handleUpdateGrade(grade._id, grade.name, grade.scale)
//                       }
//                     >
//                       Update
//                     </Button>
